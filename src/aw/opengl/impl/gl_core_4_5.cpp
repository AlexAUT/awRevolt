...
static int LoadCoreFunctions()
{
  ...
  DrawElementsInstancedBaseInstance =
      reinterpret_cast<PFNDRAWELEMENTSINSTANCEDBASEINSTANCE>(IntGetProcAddress("glDrawElementsInstancedBaseInstance"));
  ...
  InvalidateNamedFramebufferSubData =
      reinterpret_cast<PFNINVALIDATENAMEDFRAMEBUFFERSUBDATA>(IntGetProcAddress("glInvalidateNamedFramebufferSubData"));
