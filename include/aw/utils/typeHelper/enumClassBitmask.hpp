...
template <typename EnumClass>
typename std::enable_if<EnableBitMaskOperators<EnumClass>::enable, EnumClass>::type operator|(EnumClass lhs,
                                                                                              EnumClass rhs)
{
...
template <typename EnumClass>
typename std::enable_if<EnableBitMaskOperators<EnumClass>::enable, EnumClass>::type operator~(EnumClass rhs)
{
  using underlying = typename std::underlying_type<EnumClass>::type;
